...
namespace QL_KARAOKE
{
    public partial class frmMatHang : Form
    {
        ...
        private string nhanvien;//tạm thời khai báo admin. Sau này khi đăng nhập chúng ta sẽ truyền mã nhân viên sau
        ...
        private void frmMatHang_Load(object sender, EventArgs e)
        {
            ...
            cbbMatHangGoc.DataSource = db.MatHangs.Where(x=>x.IdCha ==null || x.IdCha == -1); //id cha bằng null hoặc -1 tức là không có mặt hàng nào là cha
