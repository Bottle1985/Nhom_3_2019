...
namespace QL_KARAOKE
{
    public partial class frmBanHang : Form
    {
        ...
        private void LoadPhong(int loaiphong, int tabIndex)
        {
            ...
            imgl.ImageSize = new Size(216, 118);//set size cho image
            

            //add 2 ảnh đại diện cho 2 trạng thái phòng trống và phòng đang có khách
            imgl.Images.Add(Properties.Resources.icon1);//index 0
            imgl.Images.Add(Properties.Resources.yes);//index 1
        ...
        {
            #region ton_kho_cha
            // TÍNH TỒN KHO MẶT HÀNG CHA NHẬP VÀO
        ...
        private void btnKetThuc_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                btnBatDau.Enabled = true;
                btnKetThuc.Enabled = false;
                if (MessageBox.Show("thanh toán phòng chọn < Yes >  chuyển phòng chọn < No > ", "Successfully", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
